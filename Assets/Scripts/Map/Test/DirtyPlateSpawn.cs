...
public class DirtyPlateSpawn : MonoBehaviour
{
    ...
    public List<GameObject> _spawnedDirtyPlate = new List<GameObject>();
    ...
    private void Update()
    {
        ...
        if ((_spawnedPlate.Count + _spawnedDirtyPlate.Count) < _maxPlate && !_isRespawning)
        {
    ...
    {
        float currentYOffset = _spawnedDirtyPlate.Count * _heightInterval;
        ...
        _spawnedDirtyPlate.Add(newItem);
    }
